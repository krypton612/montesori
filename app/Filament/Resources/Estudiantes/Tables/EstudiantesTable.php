                ...
                SelectFilter::make('edad')
                    ...
                    ->query(function (Builder $query, array $data) {
                        ...
                        return match($data['value']) {
                            '0-5' => $query->whereHas('persona', fn ($q) => $q->whereBetween('edad', [0, 5])),
                            '6-11' => $query->whereHas('persona', fn ($q) => $q->whereBetween('edad', [6, 11])),
                            '12-17' => $query->whereHas('persona', fn ($q) => $q->whereBetween('edad', [12, 17])),
                            '18+' => $query->whereHas('persona', fn ($q) => $q->where('edad', '>=', 18)),
                            default => $query,
                        };
                    })
                    ->native(false)
