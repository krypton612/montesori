...
class DiscapacidadEstudianteTest extends TestCase
{
    ...
    /** @test */
    public function puede_hacerse_soft_delete_y_restore_de_un_registro()
    {
        $registro = DiscapacidadEstudiante::factory()->create();
        ...
        $this->assertSoftDeleted('discapacidad_estudiante', [
            'id' => $registro->id,
        ]);
        ...
        $this->assertNull($registro->fresh()->deleted_at);
    }

    /** @test */
    public function factory_puede_crear_registros_soft_deleted_con_estado_trashed()
    {
        $registro = DiscapacidadEstudiante::factory()->trashed()->create();
